  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-3 grid-rows-3 gap-4 items-center justify-center">
        ...
        <div className="flex justify-center">
          {/* Intersección Book1+Book2, por ejemplo en la parte superior central */}
          <FlipCard 
            title="Utopia para realistas + 23 cosas que no te cuentan sobre el capitalismo" 
            topics={book1Book2} 
        ...
        {/* Fila 2 */}
        <div className="flex justify-center">
          {/* Intersección Book1+Book3 (centro-izquierda) */}
          <FlipCard 
            title="Utopia para realistas + Por qué fracasan los países" 
            topics={book1Book3} 
        ...
        <div className="flex justify-center">
          {/* Intersección de los tres, en el centro */}
          <FlipCard 
            title="Todos" 
            topics={allThree} 
            bgColor={COLORS.all} 
        ...
        <div className="flex justify-center">
          {/* Intersección Book2+Book3 (centro-derecha) */}
          <FlipCard 
